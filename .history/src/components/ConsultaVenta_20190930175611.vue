    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar color="white">
                ...
                <v-spacer><v-spacer/>
                Desde:&nbsp;
                <v-text-field type="date" v-if="verNuevo==0" class="text-xs-center" v-model="fechaInicio" append-icon="search" label="Búsqueda" single-line hide-details></v-text-field>
