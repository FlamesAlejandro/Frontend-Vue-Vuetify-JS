    ...
    <v-layout align-start>
        <v-flex>
            <v-toolbar color="white">
                ...
                Hasta:&nbsp;
                <v-text-field type="date" v-if="verNuevo==0" class="text-xs-center" v-model="fechaFin" single-line hide-details></v-text-field>
        ...
        methods:{
            ...
            listar(){
                ...
                if (!me.fechaInicio || !me.fechaFin){
                  ...
                  url='api/Ventas/ConsultaFecha/'+me.fechaInicio+'/'+me.fechaFin;
                }
